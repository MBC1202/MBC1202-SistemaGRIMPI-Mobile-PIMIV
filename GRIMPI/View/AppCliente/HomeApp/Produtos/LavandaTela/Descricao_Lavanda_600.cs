...
{
    public partial class Descricao_Lavanda_600 : Form
    {
        public Descricao_Lavanda_600()
        {
            InitializeComponent();
        }

        private void btnclose_descLavanda600_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descLavanda600_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descLavanda600_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_desLavanda600_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_desLavanda600.SelectedItem.ToString();
        ...
        public Descricao_Lavanda_600(Sacolavazia carrinho)
        {
            InitializeComponent();
        ...
        private void Descricao_Lavanda_600_Load(object sender, EventArgs e)
        {

        }

        private void buy_descLavanda600_Click(object sender, EventArgs e)
        {
            string nome = "Lavanda";
        ...
        private void carrinho_descLavanda600_Click(object sender, EventArgs e)
        {
        ...
        private void conta_descLavanda600_Click(object sender, EventArgs e)
        {
