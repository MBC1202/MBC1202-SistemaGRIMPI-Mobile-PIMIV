...
{
    public partial class Descricao_Lavanda_300 : Form
    {
        public Descricao_Lavanda_300()
        {
            InitializeComponent();
        }

        private void btnclose_descLavanda300_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descLavanda300_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descLavanda300_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_desLavanda300_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_desLavanda300.SelectedItem.ToString();
        ...
        public Descricao_Lavanda_300(Sacolavazia carrinho)
        {
            InitializeComponent();
            formCarrinho = carrinho; // Referência ao formulário do carrinho
        }

        private void buy_descLavanda300_Click(object sender, EventArgs e)
        {
            string nome = "Lavanda";
        ...
        private void carrinho_descLavanda300_Click(object sender, EventArgs e)
        {
        ...
        private void Descricao_Lavanda_300_Load(object sender, EventArgs e)
        {

        }

        private void conta_descLavanda300_Click(object sender, EventArgs e)
        {
