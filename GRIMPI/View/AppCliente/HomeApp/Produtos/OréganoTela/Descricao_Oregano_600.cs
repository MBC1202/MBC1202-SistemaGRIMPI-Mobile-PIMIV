...
{
    public partial class Descricao_Oregano_600 : Form
    {
        public Descricao_Oregano_600()
        {
            InitializeComponent();
        }

        private void btnclose_descOregano600_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descOregano600_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descOregano600_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_desOregano600_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_desOregano600.SelectedItem.ToString();
        ...
        private void Descricao_Oregano_600_Load(object sender, EventArgs e)
        {
        ...
        public Descricao_Oregano_600(Sacolavazia carrinho)
        {
            InitializeComponent();
            formCarrinho = carrinho; // Referência ao formulário do carrinho
        }

        private void buy_descOregano600_Click(object sender, EventArgs e)
        {
            string nome = "Oregano";
        ...
        private void carrinho_descOregano600_Click(object sender, EventArgs e)
        {
        ...
        private void conta_descOregano600_Click(object sender, EventArgs e)
        {
