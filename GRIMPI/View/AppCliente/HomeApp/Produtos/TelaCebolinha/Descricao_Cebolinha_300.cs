...
{
    public partial class Descricao_Cebolinha_300 : Form
    {
        public Descricao_Cebolinha_300()
        {
            InitializeComponent();
        }

        private void btnclose_descCebolinha300_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descCebolinha300_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descCebolinha300_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_descCebolinha300_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_descCebolinha300.SelectedItem.ToString();
        ...
        public Descricao_Cebolinha_300(Sacolavazia carrinho)
        {
            InitializeComponent();
            formCarrinho = carrinho; // Referência ao formulário do carrinho
        }

        private void buy_descCebolinha300_Click(object sender, EventArgs e)
        {
        ...
        private void carrinho_descCebolinha300_Click(object sender, EventArgs e)
        {
        ...
        private void conta_descCebolinha300_Click(object sender, EventArgs e)
        {
