...
{
    public partial class Descricao_Cebolinha_600 : Form
    {
        public Descricao_Cebolinha_600()
        {
            InitializeComponent();
        }

        private void btnclose_descCebolinha600_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descCebolinha600_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descCebolinha600_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_descCebolinha600_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_descCebolinha600.SelectedItem.ToString();
        ...
        public Descricao_Cebolinha_600(Sacolavazia carrinho)
        {
            InitializeComponent();
            formCarrinho = carrinho; // Referência ao formulário do carrinho
        }

        private void buy_descCebolinha600_Click(object sender, EventArgs e)
        {
        ...
        private void carrinho_descCebolinha600_Click(object sender, EventArgs e)
        {
        ...
        private void conta_descCebolinha600_Click(object sender, EventArgs e)
        {
