...
{
    public partial class Descricao_Hortela_300 : Form
    {
        public Descricao_Hortela_300()
        {
            InitializeComponent();
        }

        private void btnclose_descHortela300_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descHortela300_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descHortela300_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_descHortela300_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_descHortela300.SelectedItem.ToString();
        ...
        private void Descricao_Hortela_300_Load(object sender, EventArgs e)
        {
        ...
        public Descricao_Hortela_300(Sacolavazia carrinho)
        {
            InitializeComponent();
            formCarrinho = carrinho; // Referência ao formulário do carrinho
        }

        private void buy_descHortela300_Click(object sender, EventArgs e)
        {
            string nome = "Hortelã";
        ...
        private void carrinho_descHortela300_Click(object sender, EventArgs e)
        {
        ...
        private void conta_descHortela300_Click(object sender, EventArgs e)
        {
