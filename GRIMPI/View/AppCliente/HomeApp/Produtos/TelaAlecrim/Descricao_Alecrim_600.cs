...
{
    public partial class Descricao_Alecrim_600 : Form
    {
        public Descricao_Alecrim_600()
        {
            InitializeComponent();
        }

        private void btnclose_descAlecrim600_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descAlecrim600_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descAlecrim600_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_descAlecrim600_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_descAlecrim600.SelectedItem.ToString();
        ...
        public Descricao_Alecrim_600(Sacolavazia carrinho)
        {
            InitializeComponent();
            formCarrinho = carrinho; // Referência ao formulário do carrinho
        }

        private void buy_descAlecrim600_Click(object sender, EventArgs e)
        {
            string nome = "Alecrim";
        ...
        private void carrinho_descAlecrim600_Click(object sender, EventArgs e)
        {
        ...
        private void conta_descAlecrim600_Click(object sender, EventArgs e)
        {
