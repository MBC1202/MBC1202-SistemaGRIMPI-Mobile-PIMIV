...
{
    public partial class Descricao_Coentro_600 : Form
    {
        public Descricao_Coentro_600()
        {
            InitializeComponent();
        }

        private void btnclose_descCoentro600_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descCoentro600_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descCoentro600_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_descCoentro600_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_descCoentro600.SelectedItem.ToString();
        ...
        public Descricao_Coentro_600(Sacolavazia carrinho)
        {
            InitializeComponent();
        ...
        private void buy_descCoentro600_Click(object sender, EventArgs e)
        {
            string nome = "Coentro";
        ...
        private void carrinho_descCoentro600_Click(object sender, EventArgs e)
        {
        ...
        private void conta_descCoentro600_Click(object sender, EventArgs e)
        {
