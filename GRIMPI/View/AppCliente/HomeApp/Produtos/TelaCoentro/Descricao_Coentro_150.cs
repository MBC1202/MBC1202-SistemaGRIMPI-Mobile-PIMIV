...
{
    public partial class Descricao_Coentro_150 : Form
    {
        public Descricao_Coentro_150()
        {
            InitializeComponent();
        }

        private void btnclose_descCoentro150_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descCoentro150_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descCoentro150_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_descCoentro150_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_descCoentro150.SelectedItem.ToString();
        ...
        public Descricao_Coentro_150(Sacolavazia carrinho)
        {
            InitializeComponent();
            formCarrinho = carrinho; // Referência ao formulário do carrinho
        }

        private void buy_descCoentro150_Click(object sender, EventArgs e)
        {
            string nome = "Coentro";
        ...
        private void carrinho_descCoentro150_Click(object sender, EventArgs e)
        {
        ...
        private void conta_descCoentro150_Click(object sender, EventArgs e)
        {
