...
{
    public partial class Descricao_Coentro_300 : Form
    {
        public Descricao_Coentro_300()
        {
            InitializeComponent();
        }

        private void btnclose_descCoentro300_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private void Quemsomos_descCoentro300_Click(object sender, EventArgs e)
        {
            App app = new App();
            app.Show();
            this.Hide();
        ...
        private void logout_descCoentro300_Click(object sender, EventArgs e)
        {
        ...
        private void produtos_descCoentro300_SelectedIndexChanged(object sender, EventArgs e)
        {
            string selectedItem = produtos_descCoentro300.SelectedItem.ToString();
        ...
        public Descricao_Coentro_300(Sacolavazia carrinho)
        {
            InitializeComponent();
            formCarrinho = carrinho; // Referência ao formulário do carrinho
        }

        private void buy_descCoentro300_Click(object sender, EventArgs e)
        {
            string nome = "Coentro";
        ...
        private void carrinho_descCoentro300_Click(object sender, EventArgs e)
        {
        ...
        private void conta_descCoentro300_Click(object sender, EventArgs e)
        {
